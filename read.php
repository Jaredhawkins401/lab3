...
$table .= "<td>" . "<a href='delete.php?id=" . $row['id'] . "'>" . "Delete" . "</a>" . "</td>"; //link to delete.php with id built in, so user can select to delete the row
$table .= "<td>" . "<a href='update.php?id=" . $row['id'] . "'>" . "Update" . "</a>" . "</td>";
$table .= "\t</tr>\n";
